                ...
                child: Row(
                  ...
                  children: [
                    if (widget.isShowPlaystore &&
                        widget.data.projectLink['playstore'] != null &&
                        widget.data.projectLink['playstore']!.isNotEmpty)
                      IconButtonCustom(
                        isCustomIcon: true,
                    ...
                    if (widget.isShowAppStore &&
                        widget.data.projectLink['appstore'] != null &&
                        widget.data.projectLink['appstore']!.isNotEmpty)
                      Padding(
                    ...
                    if (widget.isShowGithub &&
                        widget.data.projectLink['github'] != null &&
                        widget.data.projectLink['github']!.isNotEmpty)
                      Padding(
                        padding: EdgeInsets.only(left: 20.h),
                        child: IconButtonCustom(
                          isCustomIcon: true,
                    ...
                    if (widget.isShowWebsite &&
                        widget.data.projectLink['website'] != null &&
                        widget.data.projectLink['website']!.isNotEmpty)
                      Padding(
                        padding: EdgeInsets.only(left: 20.h),
                        child: IconButtonCustom(
                          isCustomIcon: true,
                          customIcon: 'ic_website.png',
                          iconSize: 30.h,
                          onPressed: () {
                            AppUtils.openLink(
                                widget.data.projectLink['website']);
                          },
                        ),
                      ),
                  ],
